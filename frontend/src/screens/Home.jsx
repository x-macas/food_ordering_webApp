...
function Home() {
  ...
  const loadFoodItems = async () => {
    let response = await fetch("https://food-server-y4cf.onrender.com/api/data/foodData",{
      method: "GET",
      headers:{
  ...
  //     let response = await fetch("https://food-server-y4cf.onrender.com/api/auth/google/data", {
  //       method: "GET",
  //       headers: {
  //         "Content-Type": "application/json",
  //       },
