...
function Navbar() {
  ...
  //   const response = await fetch("https://food-server-y4cf.onrender.com/api/auth/google/data", {
  //     method: "GET",
  //     headers: {
  ...
  const handleLogOut = async () => {
      ...
      const response = await fetch("https://food-server-y4cf.onrender.com/api/auth/logout", {
        method: "GET",
        credentials: "include",
      });
